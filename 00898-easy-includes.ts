...
// ============= Your Code Here =============
type IsEqual<A, B> = (<X>() => X extends A ? 1 : 2) extends
...
//   ? [U, L] extends [L, U] ? true : Includes<R, U>
//   : false;

// type Includes<T, U> = T extends [infer L, ...infer R]
//   ? L extends U ? U extends L ? true : Includes<R, U> : Includes<R, U>
//   : false;
